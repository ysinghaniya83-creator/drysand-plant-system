                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-sand-50 border-b border-sand-100">
                            ...
                            <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide text-right">Sand (T)</TableHead>
                            <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide text-right">Coal (T)</TableHead>
                            <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Outputs</TableHead>
                            <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide text-right">Total Out (T)</TableHead>
                            <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide text-right">Wastage (T)</TableHead>
