                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-gray-50 hover:bg-gray-100 border-b-2 border-gray-200">
                            ...
                            <TableHead className="text-gray-600 text-sm font-semibold uppercase tracking-wider">Head</TableHead>
                            <TableHead className="text-gray-600 text-sm font-semibold uppercase tracking-wider">Description</TableHead>
