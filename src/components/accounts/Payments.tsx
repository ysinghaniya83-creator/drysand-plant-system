                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-sand-50 border-b border-sand-100">
                            ...
                            <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Mode</TableHead>
                            <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Reference</TableHead>
