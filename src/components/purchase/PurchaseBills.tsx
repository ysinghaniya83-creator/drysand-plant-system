                ...
                <Table>
                    <TableHeader>
                        <TableRow className="bg-gray-900 hover:bg-gray-900">
                            ...
                            <TableHead className="text-white text-xs font-mono uppercase">Bill #</TableHead>
                            ...
                            <TableHead className="text-white text-xs font-mono uppercase text-right">Bill Wt (T)</TableHead>
                            <TableHead className="text-white text-xs font-mono uppercase text-right">Rate</TableHead>
                            <TableHead className="text-white text-xs font-mono uppercase text-right">Bill Amt</TableHead>
                            <TableHead className="text-white text-xs font-mono uppercase">Status</TableHead>
                            <TableHead className="text-white text-xs font-mono uppercase text-right">Wt Diff</TableHead>
